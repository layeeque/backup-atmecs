...
function agendacall(res) {
    console.log("I am in agendacall function")

    var j = schedule.scheduleJob('*/5 * * * * *', function () {

        AWS.config.update({ accessKeyId: 'AKIAJJDOWKMC73HGQR4A', secretAccessKey: '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' , region: 'us-east-1'});

        var lambda = new AWS.Lambda();
        var params = {
            FunctionName: 'conveyhealt',
             /* required */
            Payload:  JSON.stringify({
                'x':'callForAppointment'
            }),
        };
        lambda.invoke(params, function (err, data) {
            ...
            // console.log("I am in second handlers")
            // const alexa = Alexa.handler(event, context);
            // alexa.APP_ID = "amzn1.ask.skill.a109a2a6-e7fd-4be5-a1dc-b5e5a08ebb19";
