...
restService.post('/echo', function (req, res) {
    ...
    console.log("required action is req.body.result " + req.body.result)
    console.log("required action is req.body " + req.body.json)
    console.log("required action is req " + req)
