...
self.registration.showNotification('New soda bottle popped!',{
  body:'vanilla ice cream',
  image:'icons/android-chrome-36x36.png',
  icon:'icons/android-chrome-36x36.png',
  badge:'icons/android-chrome-36x36.png',
  actions:[
    {action:'add',title:'add' ,icon:'icons/android-chrome-36x36.png'},
    {action:'rate',title:'rate' ,icon:'icons/android-chrome-36x36.png'}
  ]
