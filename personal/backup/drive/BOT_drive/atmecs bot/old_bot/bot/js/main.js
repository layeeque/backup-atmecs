...
function send() {
 ...
 //   $(".spoken-response__text").animate({ scrollTop: $(".spoken-response__text")[0].scrollHeight}, 1000);
   ...
   // $("#spokenResponse").addClass("is-active").find(".spoken-response__text").append("<br/><br/>");
    ...
    //innerDiv1.innerHTML = ("&nbsp; &nbsp;" + hour + " hrsss : " + min + " mins&nbsp; &nbsp; &nbsp;");
            ...
            if (n == true) {
                ...
                if (prompt == true) {
                    ...
                    for (i = 1; i < res.length; i++) {
                        ...
                        innerDiv.id = pid;
                        innerDiv.innerHTML = ("&nbsp;<input type='button' id='btn" + pid + "' class='btn btn-primary' style='height:40px;width:150px;text-align:center;font-size:20px' value='" + res[i] + "' onclick='func(\"" + res[i] + "\",\"" + res.length + "\")'>&nbsp;&nbsp;&nbsp;&nbsp;");
