...
var accessToken = "45386d8b872947f5af348219cda47d92",
...
function send() {
 ...
 //   $(".spoken-response__text").animate({ scrollTop: $(".spoken-response__text")[0].scrollHeight}, 1000);
   ...
   // $("#spokenResponse").addClass("is-active").find(".spoken-response__text").append("<br/><br/>");
    ...
    innerDiv1.innerHTML = ("&nbsp; &nbsp;" + hour + " hrs : " + min + " mins&nbsp; &nbsp; &nbsp;");
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (images == true) {
                ...
                $("#spokenResponse").addClass("is-active").find(".spoken-response__text").append("<li class='speechanswer message right appeared'> <div class='avatar chatbot'><img src='img/chatbot.png'></div><div class='text_wrapper'>" + "<div class='text'>");
            ...
            if (n == true) {
                ...
                if (prompt == true) {
                    ...
                    for (i = 1; i < res.length; i++) {
                        ...
                        innerDiv.id = pid;
                        innerDiv.innerHTML = ("&nbsp;<input type='button' id='btn" + pid + "' class='btn btn-primary' style='height:40px;width:200px;text-align:center;font-size:20px' value='" + res[i] + "' onclick='func(\"" + res[i] + "\",\"" + res.length + "\")'>&nbsp;&nbsp;&nbsp;&nbsp;");
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    innerDiv.id = i;
                    innerDiv.innerHTML = (" <div class='avatar chatbot'><img src='img/chatbot.png'></div><div class='text_wrapper'>" + "<div class='text'>" +"&nbsp; &nbsp; &nbsp;" + temp1 + " " + str1 + "&nbsp; &nbsp; &nbsp;<br/>" + "</div>" + "</div>");
                    //innerDiv.innerHTML = (temp1+" "+str);
                    i++;
                    $("#spokenResponse").addClass("is-active").find(".spoken-response__text").append(innerDiv);
                   // $("#spokenResponse").addClass("is-active").find(".spoken-response__text").append("<br/><br/>");
                    ...
                    var min = currentTime.getMinutes();
                    // var sec = currentTime.getSeconds();
                    innerDiv1.innerHTML = ("&nbsp; &nbsp;" + hour + " hrs : " + min + " min   &nbsp; &nbsp; &nbsp;");
                    $("#spokenResponse").addClass("is-active").find(".spoken-response__text").append(innerDiv1);
                    innerDiv1.className = "timinganswer";
                  //  $("#spokenResponse").addClass("is-active").find(".spoken-response__text").append("<br/><br/><br/><br/><br/>");
