            ...
            if (n == true) {
                ...
                if (prompt == true) {
                    ...
                    for (i = 1; i < res.length; i++) {
                        ...
                        innerDiv.id = pid;
                        innerDiv.innerHTML = ("&nbsp;<input type='button' id='btn" + pid + "' class='btn btn-primary' style='height:40px;width:100px;text-align:center;font-weight:20px;font-size: 12px;font-family: cursive;font-weight: bolder;color: white;background-color: #e5348d;border-color: blueviolet;' value='" + res[i] + "' onclick='func(\"" + res[i] + "\",\"" + res.length + "\")'>&nbsp;&nbsp;&nbsp;&nbsp;<br/><br/>");
