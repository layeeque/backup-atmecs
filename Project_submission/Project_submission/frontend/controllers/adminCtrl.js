angular.module('myExame')
    .controller('adminController', ['$scope', '$location','loginInfo','$http','$route','getapply', function($scope, $location,loginInfo,$http,$route,getapply) {
        ...
        $scope.confirm= function(a,s){
            ...
            $http.post('http://localhost:3000/changeStatus',datam).then(function (data1) {
                console.log("received result is " + JSON.stringify(data1.data))
