    ...
    .on('mail', mail => {
        ...
        crtjiratkt(mail.text, function (key) {
            getsent(mail.text, function (score) {
                ...
                var mailOptions = {
                    from: 'bprakashr@gmail.com',
                    to: mail.from[0].address,
                    subject: 'Regarding the issue raised for Jetblue',
                    text: 'We have registered your request and your request will be escalated for resolving  it as soon as possible !! \n. Your Reference number to track your request is  '+ticket
                };
